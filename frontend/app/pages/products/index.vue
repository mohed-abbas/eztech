    ...
    <div class="mx-auto max-w-6xl">
      <header class="mb-8">
        ...
        <p class="mt-2 text-text-muted">
          Available products from your catalog.
        </p>
      </header>
      ...
      <section v-else class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <article
          ...
          :key="product.id"
          class="cursor-pointer rounded-xl border border-border bg-card p-4 shadow-sm hover:shadow-md transition-shadow duration-200"
        >
          ...
          <div class="mt-4 flex items-center w-full"></div>
        </article>
      </section>
    </div>
  </main>
