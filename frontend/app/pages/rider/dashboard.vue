      ...
      <div class="flex items-center gap-2">
        <Button variant="ghost" size="sm" as-child>
          <NuxtLink to="/rider/notifications" class="relative">
            ...
            <span v-if="rider.unreadCount > 0" class="absolute -right-1 -top-1 rounded-full bg-error px-1 text-caption font-bold text-white">{{ rider.unreadCount }}</span>
          </NuxtLink>
        </Button>
    ...
    <Card v-if="rider.activeDelivery">
      <CardHeader>
        <CardTitle class="flex items-center gap-2">
          <Icon name="ph:truck" class="size-5 text-primary-600" />
      ...
      <CardContent class="space-y-3 text-body-sm">
